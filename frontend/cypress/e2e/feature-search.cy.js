  ...
  it('allows a user to type in the navbar search, press Enter, and see results', () => {
    ...
    cy.intercept(
      ...
      { 
        statusCode: 200, 
        body: [
          { _id: 'post1', title: 'My first post about a pipeline', text: 'This is the content for the first post.' },
          { _id: 'post2', title: 'My second post about a pipeline', text: 'This is the content for the second post.' },
        ]
      }
    ).as('searchRequest');
