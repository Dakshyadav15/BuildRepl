  ...
  return (
    <div className="max-w-4xl mx-auto mt-10">
      ...
      <form onSubmit={onPostSubmit} className="mb-8 p-6 bg-white rounded-lg shadow">
        <h4 className="text-lg font-semibold mb-3">Create a New Post (Image Ready)</h4>
        ...
        {/* Image Input */}
        <label htmlFor="image-upload" className="block text-sm font-medium text-gray-700 mb-2 mt-3">
