...
const Navbar = () => {
  ...
  const authLinks = (
    <>
      ...
      <a onClick={logout} href="#!" className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">
        Logout
      </a>
    </>
  );
  ...
  const guestLinks = (
    <>
      <Link to="/register" className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">Register</Link>
